        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                ...
                <a href="/" class="flex ms-2 md:me-24">
                    <img src="img/Jub.png" class="h-8 me-3" alt="FlowBite Logo" />
                    <span
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="companies"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Companaises</span>
                </a>
            </li>
            <li>
                <a href="announcements"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Annancement</span>
                </a>
            </li>
            @auth
                        ...
                        <tbody>
                            @foreach ($announcements as $announcement)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3">{{ $announcement->description }}</td>
                                    <td class="px-4 py-3">{{ $announcement->date }}</td>
                                    <td class="px-4 py-3">{{ $announcement->company->name }}</td>
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <button id="apple-imac-27-dropdown-button{{ $announcement->id }}"
                                            data-dropdown-toggle="apple-imac-27-dropdown{{ $announcement->id }}"
                                        ...
                                        <div id="apple-imac-27-dropdown{{ $announcement->id }}"
